...
\TitlePT{Algoritmos de anotação de imagem digital para
recuperação e identificação de momentos}
...
\TitleEN{Digital image annotation algorithms for
retrieval and identification of moments}
