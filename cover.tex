...
\Abstract{Palavras Chave}{Arqueologia, Deep learning, LiDAR, Unet, YOLOv7}
         {Resumo}{\selectlanguage{portuguese}Esta dissertação foi desenvolvida no âmbito do projeto ODYSEY. O projeto tem como objetivo desenvolver uma plataforma destinada a arqueólogos que contenha informação geográfica.
Dentro do âmbito do projeto, esta dissertação foca-se no uso de algoritmos de deep learning, com o objetivo de identificar sítios arqueológicos através de imagens provenientes de dados recolhidos com LiDAR. A zona escolhida para o projeto foi o Alto Minho e os objetos de estudo foram mamoas e castros. Para alcançar esse objetivo foi preciso processar essas imagens de modo a criar o dataset, assim como os métodos de data augmentation. Depois disso, foram usados dois algoritmos de deep learnin: um de object detection e o outro de semantic segmentation. YOLOv7 e Unet, respetivamente. No fim foi feito inferências nas imagens providas de modo a tentar encontrar novos sítios arqueológicos ainda não anotados.}
...
\JuriMember{Prof. Doutor Telmo Reis Cunha}{professor associado da Universidade de Aveiro}
